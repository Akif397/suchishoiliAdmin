...
@Controller
public class CntrlFindProductBySubcategory {
    private Logger logger = LoggerFactory.getLogger(CntrlFindProductBySubcategory.class);
    private final ProductSubcategoryRepository productSubcategoryRepository;
    private final ProductRepository productRepository;

    @Autowired
    public CntrlFindProductBySubcategory(ProductSubcategoryRepository productSubcategoryRepository,
